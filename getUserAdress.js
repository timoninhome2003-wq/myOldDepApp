// ====================================================
// ДОП/ПРИКОЛЬНЫЕ ФУНКЦИИ (ПОКА ЧТО В КОНСОЛЕ БРАУЗЕРА)
// ====================================================
// очистить хранилище(МОЖНО И В КОДЕ)
//console.log(sessionStorage.clear())

// На сколько четко определяет местоположениее
//LocationService.testMethods.testGPSGeocoding()
//  .then(data => console.log('Точность:', data.coords.accuracy, 'метров'))
//  .catch(err => console.log('Ошибка:', err.message));

// Координаты по широте, долготе
//navigator.geolocation.getCurrentPosition(
//  pos => console.log('Широта:', pos.coords.latitude, 'Долгота:', pos.coords.longitude, 'Точность:', pos.coords.accuracy),
